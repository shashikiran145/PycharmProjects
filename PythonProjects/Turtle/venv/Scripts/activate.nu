...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Shashi Kiran\PycharmProjects\Turtle\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Shashi Kiran\PycharmProjects\Turtle\venv\Scripts\deactivate.nu'
